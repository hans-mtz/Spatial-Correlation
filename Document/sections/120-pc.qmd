...
```{r}
#| label: tbl-pc-ts
#| tbl-cap: Rejection frequencies for different variance estimators. Time series data. PCs of the 64 B-Spline on locations for orders 1 and 2 were used to reduce error correlation. PCs were selected using BIC.
#| echo: false
#| warning: false
#| eval: true
#| include: true
