...
**UPDATE**: I used 2500 obs. Rejection frequencies drop significantly as expected.
...
I used 100 iterations to calculate the rejection frequencies and the average AR(1) coefficients of the residuals.
