...
**UPDATE**: @tbl-rho-bar-ar1 displays the average pairwise correlation for groups of different cut-off distances.
...
#| tbl-cap: Average pairwise correlation for groups of different distances.
#| echo: false
#| warning: false
