...
\section{Multi-dimensional locations}\label{sec-multi}}

\hypertarget{spatial-dgp}{%
\subsection{Spatial DGP}\label{spatial-dgp}}

In this set of simulations, the locations are two-dimensional. The
locations are independent and follow a uniform distribution.
