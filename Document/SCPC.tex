...
{\centering \includegraphics{"../Simulations/Products/hist_dist_light_locs_me_3p.png"}
...
{\centering \includegraphics{"../Simulations/Products/hist_dist_me_30p.png"}
...
\includegraphics{"../Simulations/Products/hist_gamma_o1_vd_spa_pc_nn.png"}

}

}

\subcaption{\label{fig-pc-nn-o1-nn}Order 1}
\end{minipage}%
%
\begin{minipage}[t]{0.50\linewidth}
...
\includegraphics{"../Simulations/Products/hist_gamma_o2_vd_spa_pc_nn.png"}

}

}

\subcaption{\label{fig-pc-nn-o2-nn}Order 2}
\end{minipage}%
...
\includegraphics{"../Simulations/Products/hist_pc_o1_vd_spa_pc_nn.png"}
...
\includegraphics{"../Simulations/Products/hist_pc_o2_vd_spa_pc_nn.png"}
...
\caption{\label{fig-pc-nn-vd-spa}Distribution of the number of PCs of 10
B-Splines selected in simulations. Selecting the number of PC using the
residuals' NN correlation. Spatial data with a two-dimension location.}

\end{figure}
\newpage
\hypertarget{tbl-vd-pc-bic}{}
\begin{longtable}[t]{llrrrrrrr}
...
\includegraphics{"../Simulations/Products/hist_gamma_o1_vd_spa_pc_bic.png"}

}

}

\subcaption{\label{fig-nn-o1-bic}Order 1}
\end{minipage}%
%
\begin{minipage}[t]{0.50\linewidth}
...
\includegraphics{"../Simulations/Products/hist_gamma_o2_vd_spa_pc_bic.png"}

}

}

\subcaption{\label{fig-nn-o2-bic}Order 2}
\end{minipage}%
...
\includegraphics{"../Simulations/Products/hist_pc_o1_vd_spa_pc_bic.png"}

}

}

\subcaption{\label{fig-spline-o1-vd-bic}Order 1}
\end{minipage}%
%
\begin{minipage}[t]{0.50\linewidth}
...
\includegraphics{"../Simulations/Products/hist_pc_o2_vd_spa_pc_bic.png"}

}

}

\subcaption{\label{fig-spline-o2-vd-bic}Order 2}
\end{minipage}%
...
\includegraphics{"../Simulations/Products/hist_gamma_o1_vd_spa_gamma.png"}

}

}

\subcaption{\label{fig-nn-o1-gamma}Order 1}
\end{minipage}%
%
\begin{minipage}[t]{0.50\linewidth}
...
\includegraphics{"../Simulations/Products/hist_gamma_o2_vd_spa_gamma.png"}

}

}

\subcaption{\label{fig-nn-o2-gamma}Order 2}
\end{minipage}%
...
\includegraphics{"../Simulations/Products/hist_spline_o1_vd_spa_gamma.png"}
...
\includegraphics{"../Simulations/Products/hist_spline_o2_vd_spa_gamma.png"}
...
\includegraphics{"../Simulations/Products/hist_gamma_o1_vd_spa_bic.png"}
...
\includegraphics{"../Simulations/Products/hist_gamma_o2_vd_spa_bic.png"}
...
\includegraphics{"../Simulations/Products/hist_spline_o1_vd_spa_bic.png"}
...
\includegraphics{"../Simulations/Products/hist_spline_o2_vd_spa_bic.png"}
...
\subcaption{\label{fig-gamma-bic-o1}Order 1}
\end{minipage}%
%
\begin{minipage}[t]{0.50\linewidth}
...
\subcaption{\label{fig-gamma-bic-o2}Order 2}
\end{minipage}%
...
\subcaption{\label{fig-spline-o1-bic-ts}Order 1}
\end{minipage}%
%
\begin{minipage}[t]{0.50\linewidth}
...
\subcaption{\label{fig-spline-o2-bic-ts}Order 2}
\end{minipage}%
