...
\begin{itemize}
\item
  Table~\ref{tbl-pc} shows the rejection frequencies for the optimal
  number of PCs of the 64 B-Spline for orders 1 and 2. Selecting the
  number of PCs using BIC. Spatial DGP.
\item
  Figure~\ref{fig-gamma-pc} shows the distribution of \(\gamma\), the
  residuals AR(1) slope coefficient. Figure~\ref{fig-pc} shows the
  distribution of the number of PCs selected in the simulations.
\item
  Table~\ref{tbl-gamma} displays the rejection frequencies for the
  optimal number of splines for a spatial DGP. The optimal number of
  splines was selected as the number of splines for which the OLS
  residuals produced the lowest AR(1) slope coefficient.
  Table~\ref{tbl-gamma-ts} displays the rejection frequencies for this
  same exercise but using time series DGP.
\item
  Figure~\ref{fig-gamma-nsplines} and \ref{fig-gamma-nsplines-ts}
  display the distribution of the residuals' AR(1) slope coefficient
  that was used to select the number of splines; for the spatial and
  time series DGPs.
\item
  Table~\ref{tbl-bic-ts} displays the rejection frequencies for the
  ...
  the lowest Hansen's BIC (Equation~\ref{eq-hansen-bic}) using a time
  series DGP.
\item
  Figure~\ref{fig-gamma-bic} and \ref{fig-gamma-bic-ts} show the
  distribution of the residuals' AR(1) slope coefficient that resulted
  from selecting the optimal number of splines using the BIC criteria,
  for the spatial and time series DGPs.
\end{itemize}
...
\tightlist
\item
  Use Principal components from a matrix of 64 splines, coarse grid 4,
  12,\ldots, 64, select the number of PC's using BIC after sorting them
\item
...
B-Splines evaluated on the locations. The optimal number of PCs was
selected using BIC. PCs were sorted before being selected, so the PCs
with more information were always picked first.

\hypertarget{tbl-pc}{}
\begin{longtable}[t]{llrrlrrrr}
...
\multicolumn{1}{c}{ } & \multicolumn{4}{c}{Spatial data} & \multicolumn{1}{c}{ } & \multicolumn{2}{c}{BIC} \\
\cmidrule(l{3pt}r{3pt}){2-5} \cmidrule(l{3pt}r{3pt}){7-8}
Splines & Estimator & Cons. & $\beta_1$ & S.E. $\beta_1$ & $\gamma_1$ & Hansen's & Damian's & Dropped\\
\midrule
 & HR & 0.498 & 0.385 & 0.062+0i &  &  &  & \\

 & SCPC & 0.067 & 0.073 & 0.126+0i &  &  &  & \\

 & C-SCPC & 0.055 & 0.054 & 0.126+0i &  &  &  & \\

 & Kernel 0.015 & 0.138 & 0.107 & 0.120+0i &  &  &  & \\

 & Kernel 0.030 & 0.101 & 0.117 & 0.121+0i &  &  &  & \\

\multirow[t]{-6}{*}{\raggedright\arraybackslash } & Kernel 0.050$^a$ & 0.114 & 0.135 & 0.116+0i & \multirow[t]{-6}{*}{\raggedleft\arraybackslash 0.770} & \multirow[t]{-6}{*}{\raggedleft\arraybackslash 708.622} & \multirow[t]{-6}{*}{\raggedleft\arraybackslash -6.368} & \multirow[t]{-6}{*}{\raggedleft\arraybackslash }\\
\cmidrule{1-9}
 & HR &  & 0.190 & 0.095+0i &  &  &  & \\

 & Kernel 0.015 &  & 0.073 & 0.134+0i &  &  &  & \\

 & Kernel 0.030 &  & 0.089 & 0.134+0i &  &  &  & \\

 & Kernel 0.050$^b$ &  & 0.103 & 0.130+0i &  &  &  & \\

\multirow[t]{-5}{*}{\raggedright\arraybackslash Order 1} & Damian's &  & 0.090 & 0.133+0i & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 0.260} & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 673.242} & \multirow[t]{-5}{*}{\raggedleft\arraybackslash -41.749} & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 6}\\
\cmidrule{1-9}
 & HR &  & 0.207 & 0.076+0i &  &  &  & \\

 & Kernel 0.015 &  & 0.085 & 0.106+0i &  &  &  & \\

 & Kernel 0.030 &  & 0.086 & 0.109+0i &  &  &  & \\

 & Kernel 0.050$^c$ &  & 0.090 & 0.106+0i &  &  &  & \\

\multirow[t]{-5}{*}{\raggedright\arraybackslash Order 2} & Damian's $^d$ &  & 0.101 & 0.103+0i & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 0.176} & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 585.345} & \multirow[t]{-5}{*}{\raggedleft\arraybackslash -129.646} & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 0}\\
\bottomrule
\multicolumn{9}{l}{\rule{0pt}{1em}\textit{Note: }}\\
\multicolumn{9}{l}{\rule{0pt}{1em}Average S.E. are all real except where indicated.}\\
\multicolumn{9}{l}{\rule{0pt}{1em}\textsuperscript{a} No splines Kernel (0.050) S.E. 0.11563-8.2203e-05i;}\\
\multicolumn{9}{l}{\rule{0pt}{1em}\textsuperscript{b} Order 1 splines Kernel (0.050) S.E. 0.12952-6.8368e-05i}\\
\multicolumn{9}{l}{\rule{0pt}{1em}\textsuperscript{c} Order 2 splines Kernel (0.050) S.E. 0.10616-1.9795e-05i}\\
\multicolumn{9}{l}{\rule{0pt}{1em}\textsuperscript{d} Order 2 splines Kernel (Damian's cutoff) S.E. 0.10335-0.00014435i}\\
\end{longtable}
...
\includegraphics{"../Simulations/Products/hist_gamma_o1_pc_bic.png"}
...
\includegraphics{"../Simulations/Products/hist_gamma_o2_pc_bic.png"}
...
\includegraphics{"../Simulations/Products/hist_pc_o1_pc_bic.png"}
...
\includegraphics{"../Simulations/Products/hist_pc_o2_pc_bic.png"}
...
\cmidrule{1-9}
 ...
 & Kernel 0.015 &  & 0.065 & 0.143+0i &  &  &  & \\

 & Kernel 0.030 &  & 0.075 & 0.142+0i &  &  &  & \\

 & Kernel 0.050 &  & 0.091 & 0.137+0i &  &  &  & \\

\multirow[t]{-5}{*}{\raggedright\arraybackslash Order 1} & Damian's &  & 0.072 & 0.142+0i & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 0.117} & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 700.401} & \multirow[t]{-5}{*}{\raggedleft\arraybackslash -14.589} & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 14.295}\\
\cmidrule{1-9}
 & HR &  & 0.160 & 0.082+0i &  &  &  & \\

 & Kernel 0.015 &  & 0.060 & 0.114+0i &  &  &  & \\

 & Kernel 0.030 &  & 0.054 & 0.118+0i &  &  &  & \\

 & Kernel 0.050 &  & 0.072 & 0.115+0i &  &  &  & \\

\multirow[t]{-5}{*}{\raggedright\arraybackslash Order 2} & Damian's $^b$ &  & 0.081 & 0.114+0i & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 0.052} & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 600.867} & \multirow[t]{-5}{*}{\raggedleft\arraybackslash -114.124} & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 3.533}\\
\bottomrule
\multicolumn{9}{l}{\rule{0pt}{1em}\textit{Note: }}\\
\multicolumn{9}{l}{\rule{0pt}{1em}Average S.E. are all real except where indicated.}\\
\multicolumn{9}{l}{\rule{0pt}{1em}\textsuperscript{a} No splines Kernel (0.050) S.E. 0.11563-8.2203e-05i;}\\
\multicolumn{9}{l}{\rule{0pt}{1em}\textsuperscript{b} Order 2 splines Kernel (Damian's cutoff) S.E. 0.11404-8.9653e-05i}\\
\end{longtable}
...
\includegraphics{"../Simulations/Products/hist_gamma_o1_bic_gamma.png"}

}

}

\subcaption{\label{fig-gamma-o1-spatial}Order 1}
\end{minipage}%
%
\begin{minipage}[t]{0.50\linewidth}
...
\includegraphics{"../Simulations/Products/hist_gamma_o2_bic_gamma.png"}

}

}

\subcaption{\label{fig-gamma-o2-spatial}Order 2}
\end{minipage}%

\caption{\label{fig-gamma-nsplines}Distribution of the residuals' AR(1)
slope \(\gamma\) in simulations. Selecting the number of splines using
residuals' AR(1) slopes. Spatial data.}
...
\multicolumn{5}{c}{ } & \multicolumn{4}{c}{Residuals} \\
\cmidrule(l{3pt}r{3pt}){6-9}
\multicolumn{1}{c}{ } & \multicolumn{4}{c}{Time series data} & \multicolumn{1}{c}{ } & \multicolumn{2}{c}{BIC} \\
\cmidrule(l{3pt}r{3pt}){2-5} \cmidrule(l{3pt}r{3pt}){7-8}
Splines & Estimator & Cons. & $\beta_1$ & S.E. $\beta_1$ & $\gamma_1$ & Hansen's & Damian's & Dropped\\
\midrule
 & HR & 0.514 & 0.352 & 0.063+0i &  &  &  & \\

 & Kernel 0.015 & 0.157 & 0.089 & 0.112+0i &  &  &  & \\

 & Kernel 0.030 & 0.108 & 0.079 & 0.117+0i &  &  &  & \\

\multirow[t]{-4}{*}{\raggedright\arraybackslash } & Kernel 0.050 & 0.103 & 0.104 & 0.114+0i & \multirow[t]{-4}{*}{\raggedleft\arraybackslash 0.769} & \multirow[t]{-4}{*}{\raggedleft\arraybackslash 954.080} & \multirow[t]{-4}{*}{\raggedleft\arraybackslash 239.089} & \multirow[t]{-4}{*}{\raggedleft\arraybackslash }\\
\cmidrule{1-9}
 & HR &  & 0.105 & 0.084+0i &  &  &  & \\

 & Kernel 0.015 &  & 0.033 & 0.108+0i &  &  &  & \\

 & Kernel 0.030 &  & 0.038 & 0.107+0i &  &  &  & \\

 & Kernel 0.050$^a$ &  & 0.059 & 0.105+0i &  &  &  & \\

\multirow[t]{-5}{*}{\raggedright\arraybackslash Order 1} & Damian's &  & 0.040 & 0.108+0i & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 0.050} & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 971.301} & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 256.310} & \\
\cmidrule{1-8}
 & HR &  & 0.118 & 0.074+0i &  &  &  & \\

 & Kernel 0.015 &  & 0.053 & 0.091+0i &  &  &  & \\

 & Kernel 0.030 &  & 0.047 & 0.095+0i &  &  &  & \\

 & Kernel 0.050 &  & 0.066 & 0.093+0i &  &  &  & \\

\multirow[t]{-5}{*}{\raggedright\arraybackslash Order 2} & Damian's $^b$ &  & 0.084 & 0.091+0i & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 0.049} & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 886.454} & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 171.463} & \multirow[t]{-10}{*}{\raggedleft\arraybackslash 0}\\
\bottomrule
\multicolumn{9}{l}{\rule{0pt}{1em}\textit{Note: }}\\
\multicolumn{9}{l}{\rule{0pt}{1em}Average S.E. are all real except where indicated.}\\
\multicolumn{9}{l}{\rule{0pt}{1em}\textsuperscript{a} Order 1 Splines Kernel (0.050) S.E. 0.10471-4.0992e-05i}\\
\multicolumn{9}{l}{\rule{0pt}{1em}\textsuperscript{b} Order 2 Splines Kernel (Damian's cutoff) S.E. 0.090848-0.00013041i}\\
\end{longtable}
...
\includegraphics{"../Simulations/Products/hist_gamma_o1_bic_ts_gamma.png"}
...
\includegraphics{"../Simulations/Products/hist_gamma_o2_bic_ts_gamma.png"}
...
\caption{\label{fig-gamma-nsplines-ts}Distribution of the residuals'
AR(1) slope \(\gamma\) in simulations. Selecting the number of splines
using residuals' AR(1) slopes \(\gamma\). Time series data.}
...
\multirow[t]{-6}{*}{\raggedright\arraybackslash } & Kernel 0.050 & 0.114 & 0.135 & \multirow[t]{-6}{*}{\raggedleft\arraybackslash 0.770} & \multirow[t]{-6}{*}{\raggedleft\arraybackslash 708.622} & \multirow[t]{-6}{*}{\raggedleft\arraybackslash -6.368} & \multirow[t]{-6}{*}{\raggedleft\arraybackslash }\\
\cmidrule{1-8}
 & HR &  & 0.274 &  &  &  & \\
...
\includegraphics{"../Simulations/Products/hist_gamma_o1_grid.png"}
...
\includegraphics{"../Simulations/Products/hist_gamma_o2_grid.png"}
...
\multicolumn{5}{c}{ } & \multicolumn{4}{c}{Residuals} \\
\cmidrule(l{3pt}r{3pt}){6-9}
\multicolumn{1}{c}{ } & \multicolumn{4}{c}{T.S. data} & \multicolumn{1}{c}{ } & \multicolumn{2}{c}{BIC} \\
\cmidrule(l{3pt}r{3pt}){2-5} \cmidrule(l{3pt}r{3pt}){7-8}
Splines & Estimator & Cons. & $\beta_1$ & S.E. $\beta_1$ & $\gamma_1$ & Hansen's & Damian's & Dropped\\
\midrule
 & HR & 0.514 & 0.352 & 0.063+0.000i &  &  &  & \\

 & Kernel 0.015 & 0.157 & 0.089 & 0.112+0.000i &  &  &  & \\

 & Kernel 0.030 & 0.108 & 0.079 & 0.117+0.000i &  &  &  & \\

\multirow[t]{-4}{*}{\raggedright\arraybackslash } & Kernel 0.050 & 0.103 & 0.104 & 0.114+0.000i & \multirow[t]{-4}{*}{\raggedleft\arraybackslash 0.769} & \multirow[t]{-4}{*}{\raggedleft\arraybackslash 954.080} & \multirow[t]{-4}{*}{\raggedleft\arraybackslash 239.089} & \multirow[t]{-4}{*}{\raggedleft\arraybackslash }\\
\cmidrule{1-9}
 & HR &  & 0.239 & 0.066+0.000i &  &  &  & \\

 & Kernel 0.015 &  & 0.127 & 0.087+0.000i &  &  &  & \\

 & Kernel 0.030 &  & 0.100 & 0.094+0.000i &  &  &  & \\

 & Kernel 0.050 &  & 0.116 & 0.094+0.000i &  &  &  & \\

\multirow[t]{-5}{*}{\raggedright\arraybackslash Order 1} & Damian's $^a$ &  & 0.143 & 0.090+0.000i & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 0.406} & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 895.965} & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 180.974} & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 0.000}\\
\cmidrule{1-9}
 & HR &  & 0.178 & 0.065+0.000i &  &  &  & \\

 & Kernel 0.015 &  & 0.125 & 0.079+0.000i &  &  &  & \\

 & Kernel 0.030$^b$ &  & 0.109 & 0.085+0.000i &  &  &  & \\

 & Kernel 0.050 &  & 0.118 & 0.084+0.000i &  &  &  & \\

\multirow[t]{-5}{*}{\raggedright\arraybackslash Order 2} & Damian's $^c$ &  & 0.166 & 0.077-0.001i & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 0.232} & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 845.004} & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 130.014} & \multirow[t]{-5}{*}{\raggedleft\arraybackslash 0.003}\\
\bottomrule
\multicolumn{9}{l}{\rule{0pt}{1em}\textit{Note: }}\\
\multicolumn{9}{l}{\rule{0pt}{1em}Average S.E. are all real except where indicated.}\\
\multicolumn{9}{l}{\rule{0pt}{1em}\textsuperscript{a} Order 1 Kernel (Damian's cutoff) S.E. 0.090117-0.00036245i}\\
\multicolumn{9}{l}{\rule{0pt}{1em}\textsuperscript{b} Order 2 Kernel (0.030) S.E. 0.084676-2.0017e-05i}\\
\multicolumn{9}{l}{\rule{0pt}{1em}\textsuperscript{c} Order 2 Kernel (Damian's cutoff) 0.076621-0.00076652i}\\
\end{longtable}
...
\includegraphics{"../Simulations/Products/hist_gamma_o1_bic_ts_bic.png"}
...
\includegraphics{"../Simulations/Products/hist_gamma_o2_bic_ts_bic.png"}
