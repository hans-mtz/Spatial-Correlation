...
%         end
        for o=1:N_order_splines
            ...
            if grid==0
                [x, fval] = fminbnd(@(x)get_opt_splines(x,s,o,y,X,method,cholesky_flag),5,90);
...
exportgraphics(gcf,strcat(['../Products/hist_gamma_o1_bic_' excercise '.png']))
histogram(e_ar1_betas(:,2,2));
exportgraphics(gcf,strcat(['../Products/hist_gamma_o2_bic_' excercise '.png']))
