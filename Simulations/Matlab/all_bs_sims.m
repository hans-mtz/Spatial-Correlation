...
L = [0.01 0.03 0.05 0.07]; % Vector of cutoff distances
R = [4 5 6 7]; % Number of triangles
...
N_models = 2; 
N_estimators = 2+length(L)+length(L)*length(R); 
N_reps = 250;
...
results_table
writetable(results_table,'../Products/kernel_bs_sims.csv');
