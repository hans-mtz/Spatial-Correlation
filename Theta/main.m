...
% sims_stas_tab = array2table(sims_stats(:,:,1), 'VariableNames', {'NN' 'Dropped'})

% sims_stas_tab_bs = array2table(sims_stats(:,:,2), 'VariableNames', {'NN' 'Dropped'})
...
if (save_results)
    ...
    % writetable(rej_freq_tab_k_slope,'outputs/rej_freq_tab_kernel_slope.csv');
    % writetable(rej_freq_tab_bs_slope,'outputs/rej_freq_tab_kernel_bsplines_slope.csv');
    % % writetable(img_freq_tab_bs,'outputs/img_freq_tab_kernel_bsplines.csv');
    % writetable(img_freq_tab_bs_slope,'outputs/img_freq_tab_kernel_bsplines_slope.csv');

    % % Uniform
    % % writetable(rej_freq_tab_k_u,'outputs/rej_freq_tab_kernel_u.csv');
    % % writetable(rej_freq_tab_bs_u,'outputs/rej_freq_tab_kernel_bsplines_u.csv');
    % writetable(rej_freq_tab_k_slope_u,'outputs/rej_freq_tab_kernel_slope_u.csv');
    % writetable(rej_freq_tab_bs_slope_u,'outputs/rej_freq_tab_kernel_bsplines_slope_u.csv');
    % % writetable(img_freq_tab_bs_u,'outputs/img_freq_tab_kernel_bsplines_u.csv');
    % writetable(img_freq_tab_bs_slope_u,'outputs/img_freq_tab_kernel_bsplines_slope_u.csv');
