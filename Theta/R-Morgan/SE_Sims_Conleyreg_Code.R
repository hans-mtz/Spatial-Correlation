...
#Conley SEs with and without spatial basis. Gives 1, 2, 3, and 4 times cutoff chosen. 
    cnly_1=conleyreg(eq_orig,df1,dist_cutoff = cut_off,dist_mat = DistMat,
                     kernel="bartlett",ncores = 1,verbose=F)
    cnly_basis_1=conleyreg(eq_basis,df1,dist_cutoff = cut_off,dist_mat = DistMat,
                           kernel="bartlett",ncores = 1,verbose=F)
    cnly_2=conleyreg(eq_orig,df1,dist_cutoff = 2*cut_off,dist_mat = DistMat,
                     kernel="bartlett",ncores = 1,verbose=F)
    cnly_basis_2=conleyreg(eq_basis,df1,dist_cutoff = 2*cut_off,dist_mat = DistMat,
                           kernel="bartlett",ncores = 1,verbose=F)
    cnly_3=conleyreg(eq_orig,df1,dist_cutoff = 3*cut_off,dist_mat = DistMat,
                     kernel="bartlett",ncores = 1,verbose=F)
    cnly_basis_3=conleyreg(eq_basis,df1,dist_cutoff = 3*cut_off,dist_mat = DistMat,
                           kernel="bartlett",ncores = 1,verbose=F)
    cnly_4=conleyreg(eq_orig,df1,dist_cutoff = 4*cut_off,dist_mat = DistMat,
                     kernel="bartlett",ncores = 1,verbose=F)
    cnly_basis_4=conleyreg(eq_basis,df1,dist_cutoff = 4*cut_off,dist_mat = DistMat,
                           kernel="bartlett",ncores = 1,verbose=F)
...
##Proportion signif at 5%      
     ...
     clust=small_clust$coeftable[2,4]<0.05 ,
      cnly_1=cnly_1[2,4]<0.05 ,
      cnly_basis_1=cnly_basis_1[2,4]<0.05 ,
      cnly_2=cnly_2[2,4]<0.05 ,
      cnly_basis_2=cnly_basis_2[2,4]<0.05 ,
      cnly_3=cnly_3[2,4]<0.05 ,
      cnly_basis_3=cnly_basis_3[2,4]<0.05 ,
      cnly_4=cnly_4[2,4]<0.05 ,
      cnly_basis_4=cnly_basis_4[2,4]<0.05 ,
...
###Now CIs
      ...
      ci_cnly_1=4*cnly_1[2,2] ,
      ci_cnly_basis_1=4*cnly_basis_1[2,2] ,
      ci_cnly_2=4*cnly_2[2,2] ,
      ci_cnly_basis_2=4*cnly_basis_2[2,2] ,
      ci_cnly_3=4*cnly_3[2,2] ,
      ci_cnly_basis_3=4*cnly_basis_3[2,2] ,
      ci_cnly_4=4*cnly_4[2,2] ,
      ci_cnly_basis_4=4*cnly_basis_4[2,2]   ,  #add this comma if you uncomment bch and im  
