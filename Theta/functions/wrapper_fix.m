function [sims_stats_mat,raw_data_k_u,raw_data_k_u_ci,raw_data_k,raw_data_k_ci,raw_data_bs,raw_data_bs_ci,raw_data_bs_u,raw_data_bs_u_ci,n_imaginary,n_imaginary_u] = wrapper_fix(rho,l_cutoffs,beta,theta,s, S, n_dropped, n_splines,fix,h)
