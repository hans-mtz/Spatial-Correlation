...
rng(549)
exercise = '8x8_gauss_kernel_triangle_splines'; %'8x8_fix'
description = 'Gauss Kernel; Triangle Splines; Morgans Locs; OLS NO Intercept; 1000 reps (par)';
save_results = true;
plot_res = false;
...
parfor (r=1:n_reps,M)
    ...
    [ sims_stats_mat(r,:,:,:), raw_data_k_u(r,:,:,:), raw_data_k_u_ci(r,:,:,:), raw_data_k(r,:,:,:), raw_data_k_ci(r,:,:,:), raw_data_bs(r,:,:,:), raw_data_bs_ci(r,:,:,:), raw_data_bs_u(r,:,:,:), raw_data_bs_u_ci(r,:,:,:), n_imaginary(r,:,:,:), n_imaginary_u(r,:,:,:) ] = wrapper_fix(rho,l_cutoffs,beta,theta,s,S,n_dropped,n_splines,fix,h);
...
rej_freq_tab_k_slope=array2table([rho' corr' rej_freq_k(:,:,length(beta)) sims_stats(:,1:4,1)],...
    'VariableNames', ['$\\rho$' 'corr' string(l_cutoffs) 'NN' 'Drop' 'HR' 'BIC'])

rej_freq_tab_bs_slope=array2table([rho' corr' rej_freq_bs(:,:,length(beta)) sims_stats(:,1:4,2)],...
    'VariableNames', ['$\\rho$' 'corr' string(l_cutoffs) 'NN' 'Drop' 'HR' 'BIC'])
...
img_freq_tab_bs_slope=array2table([rho' corr' img_freq_bs(:,:,length(beta)) sims_stats(:,1:4,2)],...
    'VariableNames', ['$\\rho$' 'corr' string(l_cutoffs) 'NN' 'Drop' 'HR' 'BIC'])
...
% rej_freq_tab_k_u=array2table([rho' corr' rej_freq_k_u(:,:,1) sims_stats(:,1:4,1)],...
%     'VariableNames', ['$\\rho$' 'corr' string(l_cutoffs) 'NN' 'Drop' 'HR' 'BIC'])

% rej_freq_tab_bs_u=array2table([rho' corr' rej_freq_bs_u(:,:,1) sims_stats(:,1:4,2)],...
%     'VariableNames', ['$\\rho$' 'corr' string(l_cutoffs) 'NN' 'Drop' 'HR' 'BIC'])

rej_freq_tab_k_slope_u=array2table([rho' corr' rej_freq_k_u(:,:,length(beta)) sims_stats(:,1:4,1)],...
    'VariableNames', ['$\\rho$' 'corr' string(l_cutoffs) 'NN' 'Drop' 'HR' 'BIC'])

rej_freq_tab_bs_slope_u=array2table([rho' corr' rej_freq_bs_u(:,:,length(beta)) sims_stats(:,1:4,2)],...
    'VariableNames', ['$\\rho$' 'corr' string(l_cutoffs) 'NN' 'Drop' 'HR' 'BIC'])

% img_freq_tab_bs_u=array2table([rho' corr' img_freq_bs_u(:,:,1) sims_stats(:,1:4,2)],...
%     'VariableNames', ['$\\rho$' 'corr' string(l_cutoffs) 'NN' 'Drop' 'HR' 'BIC'])

rej_freq_tab_slope_u = array2table([ rho' corr' rej_freq_k_u(:,:,length(beta)) rej_freq_bs_u(:,:,length(beta))], ...
    'VariableNames', ['rho' 'corr' string(l_cutoffs) string(l_cutoffs)+'bs' ])

img_freq_tab_bs_slope_u=array2table([rho' corr' img_freq_bs_u(:,:,length(beta)) sims_stats(:,1:4,2)],...
        'VariableNames', ['$\\rho$' 'corr' string(l_cutoffs) 'NN' 'Drop' 'HR' 'BIC'])
...
rej_freq_tab_k_slope_ci=array2table([rho' corr' rej_freq_k_ci(:,:,length(beta)) sims_stats(:,1:4,1)],...
    'VariableNames', ['$\\rho$' 'corr' string(l_cutoffs) 'NN' 'Drop' 'HR' 'BIC'])

rej_freq_tab_bs_slope_ci=array2table([rho' corr' rej_freq_bs_ci(:,:,length(beta)) sims_stats(:,1:4,2)],...
    'VariableNames', ['$\\rho$' 'corr' string(l_cutoffs) 'NN' 'Drop' 'HR' 'BIC'])
...
rej_freq_tab_k_slope_u_ci=array2table([rho' corr' rej_freq_k_u_ci(:,:,length(beta)) sims_stats(:,1:4,1)],...
    'VariableNames', ['$\\rho$' 'corr' string(l_cutoffs) 'NN' 'Drop' 'HR' 'BIC'])

rej_freq_tab_bs_slope_u_ci=array2table([rho' corr' rej_freq_bs_u_ci(:,:,length(beta)) sims_stats(:,1:4,2)],...
    'VariableNames', ['$\\rho$' 'corr' string(l_cutoffs) 'NN' 'Drop' 'HR' 'BIC'])
